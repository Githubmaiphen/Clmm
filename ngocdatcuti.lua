...
local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/Githubmaiphen/Clmm/main/hihi.lua')))()
local Window = OrionLib:MakeWindow({Name = "Lakur X", HidePremium = false,IntroText = "Night Library", SaveConfig = true, ConfigFolder = "Lakur X"})

local I = Window:MakeTab({
	Name = "Info",
	Icon = "rbxassetid://16095910858",
	PremiumOnly = false
})
...
I:AddLabel("Owner Name : Ngoc Dat")
I:AddLabel("BirthDay : 18/07/2010")
I:AddLabel("My Class : 8/6")
I:AddLabel("My Hub : Ngoc Dat Hub")
