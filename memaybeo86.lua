...
spawn(function() 
    ...
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Thì Ngoc Dat Hub đã trở lại!!!!!<Color=/>"):Display()
    wait(.14)
...
local Window = OrionLib:MakeWindow({Name = "Ngoc Dat Hub", HidePremium = false, IntroText = "Ngoc Dat Hub Library", SaveConfig = true, ConfigFolder = "Ngoc Dat Hub"})
...
OrionLib:MakeNotification({
	Name = "Ngoc Dat Hub",
	Content = "Ngoc Dat Hub Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
...
W:AddLabel("[+] Ngoc Dat Hub is back!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Ngoc Dat Hub(Noitification)",
